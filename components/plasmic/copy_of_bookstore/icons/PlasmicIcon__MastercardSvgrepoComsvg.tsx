...
export type MastercardSvgrepoComsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function MastercardSvgrepoComsvgIcon(
  props: MastercardSvgrepoComsvgIconProps
) {
  ...
  return (
    ...
    >
      ...
      <path fill={"#ff5f00"} d={"M169.81 31.89h143.72v234.42H169.81z"}></path>

      <path
        d={
          "M184.31 149.1a149.5 149.5 0 0156.74-117.21 149.1 149.1 0 100 234.42 149.5 149.5 0 01-56.74-117.21z"
        }
        fill={"#eb001b"}
      ></path>
      ...
      <path
        d={
          "M482.52 149.1a148.95 148.95 0 01-241 117.21 149.43 149.43 0 000-234.42 148.95 148.95 0 01241 117.21z"
        }
        fill={"#f79e1b"}
      ></path>
    </svg>
...
export default MastercardSvgrepoComsvgIcon;
/* prettier-ignore-end */
