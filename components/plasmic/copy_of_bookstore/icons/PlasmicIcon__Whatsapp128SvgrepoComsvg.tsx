...
export type Whatsapp128SvgrepoComsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Whatsapp128SvgrepoComsvgIcon(
  props: Whatsapp128SvgrepoComsvgIconProps
) {
...
export default Whatsapp128SvgrepoComsvgIcon;
/* prettier-ignore-end */
