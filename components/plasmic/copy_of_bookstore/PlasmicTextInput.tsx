...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 1r6uaKWmO0wZ/css
    ...
    <div
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootglobal_mode_darkMode____focusVisibleWithin]:
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__aaAm8)}
              role={"img"}
            />
          ),
      ...
      <input
        ...
        className={classNames(projectcss.all, projectcss.input, sty.input, {
          ...
          [sty.inputglobal_mode_darkMode]: hasVariant(
            globalVariants,
            "mode",
            "darkMode"
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__jdv44)}
              role={"img"}
            />
          ),
