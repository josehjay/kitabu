...
import sty from "./PlasmicLinkPreview.module.css"; // plasmic-import: Vj21mNHvgR1L/css
...
function PlasmicLinkPreview__RenderFunc(props: {
  ...
  return (
    ...
    >
      <DataCtxReader__>
        {$ctx => (
          <div className={classNames(projectcss.all, sty.freeBox__rwDl2)}>
            <PlasmicImg__
            ...
            <div className={classNames(projectcss.all, sty.freeBox__kht2R)}>
              <div className={classNames(projectcss.all, sty.freeBox__cqb1N)}>
                <h5
